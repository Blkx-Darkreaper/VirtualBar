...
export class RecipeListService extends AirtableService {
  requestUrl: string = 'Recipe%20Names?fields[]=Name&fields[]=Variant';
    ...
    GetRecipes(types: string[], styles: string[], families: string[], 
      ...
      const allRecipes = {"records":[
        {id: 'recwlMsjYThiXto6x', fields: {name: '20th Century Cocktail'}, createdTime: '2020-04-16T16:37:28.000Z'}, 
        {id: 'recZpZn7bWbxauSmP', fields: {name: 'Ahumado Seco'}, createdTime: '2020-04-16T18:17:00.000Z'}, 
        {id: 'recK7mTjXbgoIPryN', fields: {name: 'Appletini', variant: 'Sour apple schnapps'}, createdTime: '2020-04-17T02:53:04.000Z'}
      ]};
